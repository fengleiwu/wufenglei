...
- (void)viewDidLoad {
    ...
    //创建说明标签
    self.explainL = [[UILabel alloc]initWithFrame:CGRectMake(50, kScreenHeight*2/11+5+kScreenHeight/12, kScreenWidth-100, kScreenHeight/13)];
    ...
    //创建手机号码验证框
    self.phoneTF = [[UITextField alloc]initWithFrame:CGRectMake(50, kScreenHeight*2/11, kScreenWidth-100, kScreenHeight/12)];
    ...
    self.nextB.frame = CGRectMake(50, kScreenHeight*3/11 + 20, kScreenWidth-100, kScreenHeight/12);
